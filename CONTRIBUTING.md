...
Report bugs at https://github.com/diqiuzhuanzhuan/openllm-prompt-mender/issues.
...
The best way to send feedback is to file an issue at https://github.com/diqiuzhuanzhuan/openllm-prompt-mender/issues.
...
Ready to contribute? Here's how to set up `openllm-prompt-mender` for local development.

1. Fork the `openllm-prompt-mender` repo on GitHub.
2. Clone your fork locally:

   ```sh
   git clone git@github.com:diqiuzhuanzhuan/openllm-prompt-mender.git
   ```

3. Install your local copy into a virtualenv. Assuming you have virtualenvwrapper installed, this is how you set up your fork for local development:

   ```sh
   cd openllm-prompt-mender/
   uv sync
   ```
...
```sh
pytest tests.test_openllm-prompt-mender
```
